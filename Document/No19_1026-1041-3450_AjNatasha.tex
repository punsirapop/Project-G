...
\multicolumn{1}{|c|}{1}                          & Developers need to do project documents.                                     & 24                                                                        & 1        \\ \hline
\multicolumn{1}{|c|}{2}                          & Players can learn about the Genetic Algorithm.                               & 36                                                                        & 2        \\ \hline
\multicolumn{1}{|c|}{3}                          & Players can apply knowledge to solve real-world problems.                    & 36                                                                        & 3        \\ \hline
\multicolumn{1}{|l|}{4}                          & Players can breed their monsters.                                            & 24                                                                        & 4        \\ \hline
\multicolumn{1}{|l|}{5}                          & Players have mandatory goals for playing a game.                             & 16                                                                        & 5        \\ \hline
\multicolumn{1}{|l|}{6}                          & Players have other activities to spend their time during the breeding phase. & 36                                                                        & 6        \\ \hline
\multicolumn{1}{|l|}{7}                          & Developers integrate all the systems.                                        & 24                                                                        & 7        \\ \hline
...
%	\begin{minipage}[c]{\textwidth}\centering
%	\fbox{\includegraphics[width=12cm]{figure/design-farm-state-diagram.png}}
...
Farm 2 & \begin{tabular}[c]{@{}l@{}}Unlock Factory 3\\ Money\end{tabular} \\ \hline
Farm 3 & \begin{tabular}[c]{@{}l@{}}Unlock Factory 5\\ Money\end{tabular} \\ \hline
\end{longtable}
...
\end{longtable}
	...
	\captionof{figure}{Interface of Monster Shop Page}
...
\noindent{\large\bf Learning Material in Research Lab} \label{appendix:learning-material} \\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix{Puzzles }
\noindent{\large\bf Puzzle Storyboard} \label{appendix:puzzle-storyboard} \\
